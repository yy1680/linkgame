...
public class SettingsActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupActionBar();
        getFragmentManager().beginTransaction().replace(android.R.id.content,new MyPreferenceFragment(),"MyPreferenceFragment").commit();
    }
    ...
    public static class MyPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("pref_row"));
            bindPreferenceSummaryToValue(findPreference("pref_col"));
        }
    }
}
